...
let
  ...
  pkcs11ta = args: (buildOptee (args // {
    ...
    installPhase = ''
      ...
      mkdir -p $out
      cp ./out/ta/pkcs11/fd02c9da-306c-48c7-a49c-bbd827ae86ee.ta $out/fd02c9da-306c-48c7-a49c-bbd827ae86ee.ta
...
in
{
  inherit buildTOS buildOpteeTaDevKit opteeClient pkcs11ta;
}
