...
let
  ...
  }) buildTOS buildOpteeTaDevKit opteeClient pkcs11ta;
  ...
  devicePkgsFromNixosConfig = callPackage ./device-pkgs.nix {
    inherit l4tVersion pkgsAarch64 flash-tools flashFromDevice edk2-jetson uefi-firmware buildTOS buildOpteeTaDevKit opteeClient pkcs11ta bspSrc;
  };
